...
- The homepage `site/src/pages/index.astro` (~2500 lines) is intentionally standalone with its own layout/CSS/JS; every other page uses `site/src/layouts/Base.astro` + `site/src/styles/global.css`.
